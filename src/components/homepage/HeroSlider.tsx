...
export function HeroSlider() {
  ...
  return (
    <section className="bg-light-bg dark:bg-aura-black px-4">
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                  <h2 className="mb-4 font-heading text-3xl font-bold text-aura-soft-white sm:text-4xl">
                    {slide.title}
                  </h2>
                  <button className="rounded-full bg-brand-red text-white dark:bg-aura-green dark:text-aura-black px-8 py-3 font-sans text-sm font-bold uppercase tracking-wide transition-transform hover:scale-105 active:scale-95">
                    {slide.ctaText}
                  </button>
                </div>
              </div>
